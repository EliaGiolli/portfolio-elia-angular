...
export const projects: ProjectsTypes[] = [
    ...
    },
    {
        ...
        "img_path": "",
        "description": "A personal blog on contemporary history and geopolitics, built with Astro content collections: articles and recommended readings validated at build time and filterable by tag.",
    ...
    },
    {
        ...
        "img_path": "",
        "description": "A NestJS API that models a personal library as a graph: books, authors and tags, plus directional connections aggregated into nodes and edges for visualisation.",
    ...
    },
    {
        ...
        "img_path": "",
        "description": "An Angular server-monitoring dashboard: live status cards, search and analytics, with HTTP interceptors standing in for a backend and Zod validating every response.",
